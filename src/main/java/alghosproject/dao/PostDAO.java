...
public class PostDAO {
    ...
    public MyArrayList<Post> getAllPosts() throws SQLException {
    ...
    public Post setProperties(ResultSet resultSet) throws SQLException {
        ...
        return new Post(id, description, created_at, user_id, name, likes);
    }
